...
urlpatterns_client = [
    ...
    url(r'^inventory/delivery/(?P<shipment_id>\d+)/products/$', client_views.client_delivery_products, name='client-delivery-products'),
...
urlpatterns_warehouse = [
    ...
    url(r'^shipment/(?P<shipment_id>\d+)/bill_of_lading/$', warehouse_views.BillOfLadingView.as_view(), name='warehouse-bill-of-lading'),
    url(r'^shipment/doc/(?P<doc_id>\d+)/delete/$', warehouse_views.ShipmentDocDelete.as_view(), name='warehouse-shipment-doc-delete'),
